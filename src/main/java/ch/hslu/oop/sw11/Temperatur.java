...
public final class Temperatur implements Comparable<Temperatur> {
    private final float celsius; //this immer wenn zugriff auf attribut // wert kann auch hier sschon festgelegt werden
    ...
    private Temperatur(final Temperatur temperatur){
    ...
    return new Temperatur(Temperatur.convertKelvintoCelsius(kelvin));
    }

    // immutable klasse deshalb keine setter mehr:
